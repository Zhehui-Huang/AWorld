...
4) **Final Answer**: First Call `mcp_save_task_memory` to persist all relevant task information, then present the final answer wrapped in `<search agent answer>FORMATTED ANSWER</search agent answer>` tags.
...
- **Final Answer**: 
    - Always call `mcp_save_task_memory` to persist all relevant task information before returning your final answer.
